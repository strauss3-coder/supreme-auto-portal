...
--     testimonials and settings, and may INSERT an enquiry. Nothing else.
...
-- Single row per settings document: homepage, contact and meta. The portal
-- reads and writes these as whole documents.
